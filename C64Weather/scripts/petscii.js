...
(function (global) {
  ...
  var STROKE_ART = {
    ...
    /* Two flakes, not three: at the arm length and 3-unit spacing the original
       three carried, they touched and read as one smudge rather than falling
       snow. Wider apart (6.5 to 8.5 unit spacing) and larger (arm 1.9 vs 1.2),
       two flakes read as distinct crystals and stay clearly unlike rain's three
       parallel diagonal strokes and drizzle's two short ones. */
    snow: 'M7 14.6h9.5a3.8 3.8 0 0 0 .4-7.6A5.6 5.6 0 0 0 6.2 5.7 3.9 3.9 0 0 0 7 14.6z|M6.6 19.5L10.4 19.5|M7.5 17.9L9.5 21.1|M9.5 17.9L7.5 21.1|M13.6 19.5L17.4 19.5|M14.5 17.9L16.5 21.1|M16.5 17.9L14.5 21.1',
